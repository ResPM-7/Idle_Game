...
public class WaveManager : Singleton<WaveManager>
{
    ...
    [SerializeField] private int bossUnitId = 301;
    ...
    void StartBossBattle()
    {
        ...
        {
            Debug.LogWarning("WaveManager의 EnemyUnitData가 비어 있습니다.");
            currentState = WaveState.WaitingBoss;
            return;
        }

        UnitData bossData = enemyUnitData.GetById(bossUnitId);
        if (bossData == null)
        {
            Debug.LogWarning($"EnemyUnitData에서 보스 unitId {bossUnitId}를 찾을 수 없습니다.");
            currentState = WaveState.WaitingBoss;
            return;
        }
